<template>
  <div class="container">
    <h1 class="#f3e5f5 purple lighten-5 center">サインアップ</h1>
    <form class="col" @submit.prevent="signup">
      ...
      <button type="submit" class="btn btn-outline-secondary" >サインアップ</button>
      <br>
      <div><router-link to="/signin" class="btn btn-outline-secondary">サインインに移動</router-link></div>
    </form>
  </div>
</template>
